...
invertidos móbiles \citep{Yan-Hou}, ya que su base no está fija en el espacio, sino que puede
...
en donde el el mismo puede considerarse como lineal. En el caso específico del sistema a analizar,
