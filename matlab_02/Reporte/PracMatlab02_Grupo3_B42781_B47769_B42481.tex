...
\begin{figure}
	...
	\end{subfigure}
	\caption[justification=centering]{Primera simulación gráfica de los estados. En los ejes se tienen los estados y el tiempo se denota con el cambio de color}
...
\begin{figure}
	...
	\end{subfigure}
	\caption[justification=centering]{Segunda simulación gráfica de los estados. En los ejes se tienen los estados y el tiempo se denota con el cambio de color}
...
\begin{figure}
	...
	\end{subfigure}
	\caption[justification=centering]{Cuarta simulación gráfica de los estados. En los ejes se tienen los estados y el tiempo se denota con el cambio de color}
...
\begin{figure}
	...
	\end{subfigure}
	\caption[justification=centering]{Quinta simulación gráfica de los estados. En los ejes se tienen los estados y el tiempo se denota con el cambio de color}
