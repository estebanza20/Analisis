...
A partir de la gráfica de la figura \ref{fig:2_c_carga} se puede decir que la corriente en la carga varía al igual que el voltaje de salida, de modo que tampoco parece ser muy significativo, si se piensa en la temperatura a la que tuvo que llegar hacer un poco más apreciable su efecto se puede dar cuenta de que probablemente el circuito estaría derretido pues (1200 K-$926 ^o C$) es una temperatura bastante elevada.
